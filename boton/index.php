...
<?php
	...
	{
		$montos['BA'] = "entre $1200 y $1500";
		$montos['MIS-OBE'] = "entre $1200 y $1500";
		$montos['MIS-POS'] = "entre $1200 y $1500";
		$montos['NQN-RN'] = "entre $1500 y $1800";
		$montos['COCHA'] = "entre $800 y $1000";
		$montos['TUC'] = "entre $1500 y $1800";
		$montos['CBA'] = "entre $1200 y $1500";
		$montos['SAL'] = "entre $1500 y $1800";
		$montos['ROS'] = "entre $1200 y $1500";
					...
					<ul><?php if ($orden == 'TDI' || $orden == 'TDV')
						{	
							echo "<h4>Nombre y Apellido:</h4>
								...
								<br/>
								<h4>¿Desde que sede estas confirmando?</h4>
								<select>
								<option value='Opción'>Elegí tu Sede</option>
								<option value='Córdoba'>Córdoba</option>
								<option value='Misiones'>Misiones</option>
								<option value='Salta'>Salta</option>
								<option value='Buenos Aires'>Buenos Aires</option>
								<option value='Tucumán'>Tucumán</option>
								<option value='Corrientes / Chaco'>Corrientes / Chaco</option>
								<option value='Santa Fe'>Santa Fe</option>
								<option value='Neuquén / Río Negro'>Neuquén / Río Negro</option>
